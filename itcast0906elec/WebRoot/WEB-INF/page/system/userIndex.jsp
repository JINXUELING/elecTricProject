                ...
                <tr>
                    ...
                    <td class="ta_01" align="right">
                        ...
                        <input style="font-size:12px; color:black; height=20;width=80" id="BT_Export" type="button" value="导出" name="BT_Export" 
                         ...
                         <input style="font-size:12px; color:black; height=20;width=80" id="BT_Import" type="button" value="统计" name="BT_Import" 
                         onclick="openWindow('${pageContext.request.contextPath }/system/elecUserAction_charUser.do','700','400')">&nbsp;&nbsp;
                    </td>
                </tr>
