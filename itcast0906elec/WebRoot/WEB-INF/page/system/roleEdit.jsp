...
<table cellSpacing="1" cellPadding="0" width="90%" align="center"
                ...
                <table cellSpacing="0" cellPadding="0" width="90%" align="center"
                    ...
                    <tr>
                        <td class="ta_01" colspan=2 align="left" width="100%">
                            全选/全不选
                            <input type="checkbox" name="selectOperAll"
                                    ...
                                    <s:if test="%{#request.parentCode == #xml.parentCode}">
                                        <s:if test="%{#xml.flag==1}">
                                            <input type="checkbox" name="selectoper"
                                                value="<s:property value="%{#xml.code}"/>" checked="checked">
                                        </s:if>
                                        <s:else>
                                            <input type="checkbox" name="selectoper"
                                                value="<s:property value="%{#xml.code}"/>">
                                        </s:else>
                                        <s:property value="%{#xml.name}" />
                                    </s:if>
                                    <s:else>
                                        <s:set name="parentCode" scope="request"
                                            value="%{#xml.parentCode}"></s:set>
                                        <br>
    ...
    <tr>
        <td>
            ...
            <fieldset
                style="width: 100%; border: 0px solid #73C8F9; text-align: left; COLOR: #023726; FONT-SIZE: 12px;">
                <legend align="left">
                    用户分配
                </legend>

                <table cellspacing="0" align="center" width="100%" cellpadding="1"
                    rules="all" bordercolor="gray" border="1" id="DataGrid1"
                    ...
                    <tr
                        ...
                        <td class="ta_01" align="center" width="20%" height=22
                            ...
                            选中
                            <input type="checkbox" name="selectUserAll"
                    ...
                    <s:if test="#request.userList!=null && #request.userList.size()>0">
                        <s:iterator value="%{#request.userList}" var="user">
                            <tr onmouseover="this.style.backgroundColor = 'white'"
                                ...
                                <td style="HEIGHT: 22px" class="ta_01" align="center"
                                    width="20%">
    ...
    <tr>
        <td class="ta_01" align="center" colspan=3 width="100%" height=20>
            <input type="button" name="saverole" onclick="saveRole()"
                style="font-size: 12px; color: black;" value="保存">
        </td>
    </tr>
</table>
