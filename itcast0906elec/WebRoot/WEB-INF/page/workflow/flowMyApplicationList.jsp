...
<body>
		...
		<form id="Form1" name="Form1" action="${pageContext.request.contextPath }/workflow/elecApplicationFlowAction_myApplicationList.do" method="post" style="margin:0px;"> 
			<table cellspacing="1" cellpadding="0" width="90%" align="center" bgcolor="#f5fafe" border="0">
				...
				<tr>
					...
					审核状态：</td>
					<td class="ta_01" >
						<s:select list="#request.systemList" name="status" id="status" 
